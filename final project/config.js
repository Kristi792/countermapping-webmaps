var config = {
    ...
    chapters: [
        ...
        },
        {
            ...
            description2: 'This map overlays a buffer of EV charging stations within a 1-mile radius with median household income data, highlighting disparities in accessibility. Areas with higher median household incomes (shown in dark purple) do not always have better access to charging stations within a 1-mile radius, reflecting underlying inequalities in infrastructure for wealthier communities that can afford EVs. Conversely, light purple areas (representing lower-income areas) do not always have access to charging stations without restrictions and some have more convenient EV charging stations. This highlights the need for targeted infrastructure planning to ensure equitable access to EV charging, especially in communities that have the potential to purchase EVs but do not have convenient charging facilities.',
            location: {
        ...
        },
        {
            ...
            alignment: 'left',
            hidden: false,
            title: 'Land Use, Residence Types and Charging Needs',
